...
public class UsuarioDAO extends DAO {
    ...
    public void crearUsuario(Usuario usuario) throws Exception {
        ...
        //INSERT INTO usuario VALUES('234', 'asd', 'asdas', 45)
        
        try {

            String sql = "INSERT INTO usuario VALUES ('" + usuario.getClave() + "', '" 
    ...
    public Usuario buscarPorCorreoElectronico(String correo) throws Exception {
        ...
        try {
            String sql = "SELECT * FROM usuario WHERE correoElectronico LIKE '" + correo + "'";
    ...
    public void modificarUsuario(Usuario usuario) throws Exception {
        ...
        try {
            ...
            String sql = "UPDATE usuario SET nombre='" + usuario.getNombre()
                    + "' WHERE correoElectronico LIKE '" + usuario.getCorreoElectronico() + "'";
...
// INSERT INTO usuario VALUES ('123','valen'  "
